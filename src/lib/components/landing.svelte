<script lang="ts">
  ...
  import {
    APPOINTMENT_PHONE,
    petImages, // Keep importing petImages
    servicesList,
...
<!-- Hero Section -->
<main
  class="dark:bg-gray-900 bg-white relative overflow-hidden pt-8 flex items-center"
>
  ...
  <div
    class="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-0 md:gap-16 lg:gap-24 max-w-7xl relative z-10"
  >
    <!-- Left Section -->
    <div class="flex flex-col items-start text-left lg:w-1/2">
      ...
      >
        Compassionate Care
        <span
          class="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-pink-500 dark:text-pink-400"
          >For Your Beloved Pets</span
        >
      </h1>

      <p
        class="mt-6 text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-300"
      >
        We are dedicated to providing the highest level of veterinary medicine
      ...
      <div class="flex mt-8 gap-4 flex-wrap">
        ...
        <button
          ...
          class="uppercase py-3 px-6 rounded-lg bg-transparent border-2 border-pink-500 text-pink-500 dark:text-white hover:bg-pink-500 hover:text-white text-sm sm:text-base transition-colors
                    dark:border-pink-600 dark:hover:bg-pink-600 dark:hover:text-white"
        >
          Our Services
        </button>
      </div>
    ...
    <div class="lg:w-1/2 w-full mt-8 lg:mt-0">
      <!-- Marquee for Mobile Devices (hidden on md and up) -->
      <div class="md:hidden">
        <Marquee images={petImages} />
      </div>

      <!-- Static Grid for Desktop/Tablet (hidden on xs/sm) -->
      <div class="hidden md:block">
        <div class="columns-2 sm:columns-4 gap-4 p-2">
...
<section class="py-20 bg-gray-50 dark:bg-gray-900">
  <div class="container mx-auto px-6 text-center">
    ...
    <p class="text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
      We offer a wide range of veterinary services to ensure your pet lives a
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {#each servicesList as service, i}
        ...
        >
          ...
          <p
            class="text-gray-500 dark:text-gray-300 flex-grow mb-4 text-center"
          >
            {service.description}
          </p>
          <button
...
<section class="bg-pink-500 dark:bg-pink-700">
  <div class="container mx-auto px-6 py-16 text-center">
    ...
    <p class="text-white/90 text-xl mb-6">
      We are here to help. Call us immediately for urgent care.
    </p>
    <a
